...
const PetCard = (props) => {
  ...
  const addtoWishHandler = () => {
    dispatch(
      wishActions.addItemsToWishList({
        id: props.id,
        name: props.name,
        src: props.src,
      })
  ...
  const sendDataToSinglePet = () => {
    if (props.type === "dog") {
      dispatch(
        singlePetActions.sendDataFromDogs({
          id: props.id,
          name: props.name,
          src: props.src,
          height: props.height,
      ...
      dispatch(
        singlePetActions.sendDataFromCats({
          id: props.id,
          name: props.name,
          src: props.src,
          desc: props.desc,
        ...
        <div className={styles.card_parent}>
          <div className={styles.card_content}>
            ...
            <div className={styles.card_caption}>
              ...
              <button
                onClick={token ? addtoWishHandler : handleShow}
                title="add to wishlist"
                className={styles.card_wish}
              >
