...
const Dogs = () => {
  const allDogs ="1,5,6,7,8,9,10,12,13,14,18,19,23,24,101,103,111,114,121,124,125,130"
  ...
  return (
    <div className={styles.container}>
      ...
      <Container fluid className='px-lg-5'>
        <DogsSelection name='dogType'  runSelectHandler={setSelectedHandler} allDogs={allDogs}/>
